...
async function getWorldTopojson() {
    ...
    await mapshaper.runCommands(`-i ${assetsPath}/adm1_simplified.geojson -dissolve shapeGroup -clean -o quantization=100000000000 ${assetsPath}/world_adm0_simplified_topo.topojson`);
