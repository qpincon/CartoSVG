...
(function (global, factory) {
 true ? factory(exports, __nccwpck_require__(471)) :
0;
...
var node_domexception = __nccwpck_require__(640);
// EXTERNAL MODULE: ./node_modules/fetch-blob/file.js
var file = __nccwpck_require__(451);
...
class Body {
	...
	async formData() {
		...
		const {toFormData} = await __nccwpck_require__.e(/* import() */ 254).then(__nccwpck_require__.bind(__nccwpck_require__, 254));
...
var from = __nccwpck_require__(393);
...
// EXTERNAL MODULE: ./node_modules/topojson-client/dist/topojson-client.js
var topojson_client = __nccwpck_require__(471);
// EXTERNAL MODULE: ./node_modules/topojson-simplify/dist/topojson-simplify.js
var topojson_simplify = __nccwpck_require__(795);
;// CONCATENATED MODULE: external "fs"
const external_fs_namespaceObject = __WEBPACK_EXTERNAL_createRequire(import.meta.url)("fs");
;// CONCATENATED MODULE: ./getAndSimplifyWorld.js
...
async function getWorldTopojson(){
    ...
    external_fs_namespaceObject.writeFileSync(`world_adm1_simplified.topojson`, JSON.stringify(quantized));
    return true
}
